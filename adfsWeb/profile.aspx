...
<html lang="en">
    <head>
		...
		<!-- font awsome -->
		<link rel="stylesheet" href="css/font-awsome.css" type="text/css" media="all">
...
<!-- hidden form for user's name and username and will be used in Jquery Ajax to send request to API server -->
    <form id="profileform">
       ...
       <input type="hidden" name="Name" id="Name" value="enio"  runat= "server" />
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#"><span id="usernameonicon" class="glyphicon glyphicon-user" ><asp:Label ID="usernameLabel" runat="server">username</asp:Label></span></a></li>
        <li>
