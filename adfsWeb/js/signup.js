 ...
 * javascript or Jquery file for signup.aspx page
     ...
     var role = $('#role').val();
       ...
       {    
           ...
           //get the form data using another method  
            ...
            $.ajax({
                type: "POST",
                url: "https://192.168.255.11:7443/WebAPI/AddUser",
                data: dataString,
                dataType: "json",
...
function SendEmail(fname,lname,email){
  ...
  var verificationlink = "https://localhost:497/account/Activate.aspx";  
  dataString ="subject="+subject+"&body="+body+"&link="+verificationlink+ "&fname=" + fname+"&lname="+lname+"&receiveremail="+email;
     $.ajax({
            type: "POST",
            url: "https://192.168.255.11:7443/WebAPI/SendEmail",
            data: dataString,
            dataType: "json", 
            success: function( result) {
...
function ShowSuccessMessage(result){
 if(result.Status==="success"){
    ...
    $('#modalbodycontent').html("<p><strong>registration "+result.Status+"</strong></p>"+"<p>Congratulation,your account is created</p>"+
       ...
       +"<p> go to<a href=index.aspx> login "+"</a></p>");
